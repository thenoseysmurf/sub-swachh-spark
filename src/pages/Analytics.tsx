...
const categories = [
  {
    ...
    savings: 890,
    apps: [
      { name: "Netflix", icon: Play, amount: 799 },
      { name: "Spotify", icon: Music, amount: 119 },
      { name: "Prime Video", icon: Film, amount: 299 },
      { name: "YouTube Premium", icon: Play, amount: 129 }
    ]
  },
  {
    id: 2,
    ...
    savings: 450,
    apps: [
      { name: "Nike Training", icon: Dumbbell, amount: 299 },
      { name: "MyFitnessPal", icon: Heart, amount: 199 },
      { name: "Headspace", icon: Heart, amount: 299 }
    ]
  },
  {
    id: 3,
    ...
    savings: 320,
    apps: [
      { name: "Skillshare", icon: BookOpen, amount: 299 },
      { name: "Coursera", icon: GraduationCap, amount: 399 },
      { name: "Duolingo", icon: BookOpen, amount: 149 }
    ]
  },
  {
    id: 4,
    ...
    savings: 180,
    apps: [
      { name: "Zomato Pro", icon: Coffee, amount: 299 },
      { name: "Amazon Prime", icon: ShoppingBag, amount: 199 }
    ]
  }
];
      ...
      <div className="px-4 pt-2 pb-8 space-y-8">
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <p className="text-sm text-muted-foreground">{categories.length} active</p>
          </div>
          ...
          <div className="space-y-5">
            {categories.map((category) => {
              ...
              return (
                <WidgetCard key={category.id} className="p-5 animate-fade-in hover-scale">
                  {/* Category Header */}
                    ...
                    <div className="flex space-x-3 flex-1">
                      {category.apps.slice(0, 4).map((app, index) => {
                        ...
                        return (
                          <div
                            key={index}
                            className="w-8 h-8 bg-muted/50 rounded-lg flex items-center justify-center hover:bg-muted transition-colors"
                      ...
                      {category.apps.length > 4 && (
                        <div className="w-8 h-8 bg-muted/50 rounded-lg flex items-center justify-center text-xs text-muted-foreground">
                          +{category.apps.length - 4}
                        </div>
                      )}
                    </div>
